  ...
  return (
    <div className="flex justify-center w-full  flex-col gap-12 ">
      ...
      <p className="text-xl tracking-wide">
        ...
        içe, dinamik, yetkin ve deneyimli kadrosu ve proaktif yaklaşımıyla
        hizmet vermektedir. Şirketler ve yatırımcılarla iletişime geçerek
        onların tüm ihtiyaçlarını karşılıyoruz.
      </p>
    </div>
  );
};
